...
export function FlightBottomTabs({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 bg-[#ffffff] dark:bg-zinc-900 border-t border-zinc-200 dark:border-zinc-800 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
      <div
        ref={scrollRef}
      ...
      >
        ...
        <button
          onClick={onAddFlight}
          className="flex-shrink-0 flex items-center justify-center h-full px-4 border-l border-zinc-100 dark:border-zinc-800 text-orange-500 hover:bg-orange-50 dark:hover:bg-orange-500/10 transition-colors"
