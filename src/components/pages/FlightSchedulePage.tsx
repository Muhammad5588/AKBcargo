...
const FlightCard = memo(({ flight, simple = false }: { flight: Flight; simple?: boolean }) => {
  ...
  return (
    <div
      className={`group relative flex items-center gap-4 overflow-hidden rounded-lg border p-4 shadow-sm transition-all ${
        simple ? "border-[#dbe8f4] bg-white" : "border-[#dbe8f4] bg-white hover:border-[#0b84e5]"
      }`}
    >
